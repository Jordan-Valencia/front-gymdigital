            ...
            {productosFiltrados.map((producto) => (
              ...
              >
                ...
                <button
                  ...
                  className="mt-3 w-full bg-indigo-600 text-white py-2 px-4 rounded-lg hover:bg-indigo-700 disabled:bg-gray-300 flex items-center justify-center gap-2"
                >
                  ...
                  <div key={item.producto.id} className="border-b pb-3">
                    ...
                    <div className="flex justify-between mt-1">
                      ...
                      <span className="font-medium">
                        $
                        {(
                          (item.producto.precio_unitario || 0) * item.cantidad
                        ).toFixed(2)}
                      </span>
                    </div>
                  </div>
